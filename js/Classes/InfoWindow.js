  ...
  template(name, lat, long, address, comments, stars) {
    let template = `
      <div class="infoWindow">
        ...
        <img 
        src="https://maps.googleapis.com/maps/api/streetview?size=300x200&location= ${lat},${long} &heading=151.78&pitch=-0.76&key=AIzaSyAI-zsq436f9KO_AT_EgfO2PoOh0qznsZE">
        </img>
        <h3>${address}</h3>
